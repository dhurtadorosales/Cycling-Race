...
public class ClafEtapa5 extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClafEtapa5 frame = new ClafEtapa5();
	 ...
	 */
	public ClafEtapa5() throws ClassNotFoundException, SQLException {
		...
		JLabel lblClasificacinQuintaEtapa = new JLabel("CLASIFICACIÓN QUINTA ETAPA");
		lblClasificacinQuintaEtapa.setHorizontalAlignment(SwingConstants.CENTER);
		lblClasificacinQuintaEtapa.setForeground(Color.DARK_GRAY);
		lblClasificacinQuintaEtapa.setFont(new Font("Dialog", Font.BOLD, 26));
		lblClasificacinQuintaEtapa.setBounds(295, 0, 551, 75);
		getContentPane().add(lblClasificacinQuintaEtapa);
		...
		table.setModel(new DefaultTableModel(
			conectarse.ConsultaClafEtapa(5),
			new String[] {
