...
public class ClafEtapa2 extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClafEtapa2 frame = new ClafEtapa2();
	 ...
	 */
	public ClafEtapa2() throws ClassNotFoundException, SQLException {
		...
		JLabel lblClasificacinSegundaEtapa = new JLabel("CLASIFICACIÓN SEGUNDA ETAPA");
		lblClasificacinSegundaEtapa.setHorizontalAlignment(SwingConstants.CENTER);
		lblClasificacinSegundaEtapa.setForeground(Color.DARK_GRAY);
		lblClasificacinSegundaEtapa.setFont(new Font("Dialog", Font.BOLD, 26));
		lblClasificacinSegundaEtapa.setBounds(295, 0, 551, 75);
		getContentPane().add(lblClasificacinSegundaEtapa);
		...
		table.setModel(new DefaultTableModel(
			conectarse.ConsultaClafEtapa(2),
			new String[] {
