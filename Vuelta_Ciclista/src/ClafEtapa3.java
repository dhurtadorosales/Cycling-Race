...
public class ClafEtapa3 extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClafEtapa3 frame = new ClafEtapa3();
	 ...
	 */
	public ClafEtapa3() throws ClassNotFoundException, SQLException {
		...
		JLabel lblClasificacinTerceraEtapa = new JLabel("CLASIFICACIÓN TERCERA ETAPA");
		lblClasificacinTerceraEtapa.setHorizontalAlignment(SwingConstants.CENTER);
		lblClasificacinTerceraEtapa.setForeground(Color.DARK_GRAY);
		lblClasificacinTerceraEtapa.setFont(new Font("Dialog", Font.BOLD, 26));
		lblClasificacinTerceraEtapa.setBounds(295, 0, 551, 75);
		getContentPane().add(lblClasificacinTerceraEtapa);
		...
		table.setModel(new DefaultTableModel(
			conectarse.ConsultaClafEtapa(3),
			new String[] {
